...
const seedDB = async () => {
  ...
  for (let i = 0; i < 500; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reprehenderit deserunt praesentium dolore voluptatibus mollitia earum excepturi ea beatae, nemo placeat quidem, assumenda debitis officia numquam cumque sunt nisi facilis totam.",
      price,
